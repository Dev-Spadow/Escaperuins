...
public final class NpcDefinition {
	...
	public static final int CUSTOM_NPCS = 21;
	...
	public static void init(FileArchive archive) {
		...
		offsets = new int[size + CUSTOM_NPCS];
		...
		System.out.println("Loaded: " + size + " mobs from Cache");
		System.out.println("Loading additional " + CUSTOM_NPCS + " mobs from Hard Code");
	}
