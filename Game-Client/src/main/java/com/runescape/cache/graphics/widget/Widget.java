...
*/
	...
	public static void questTab() {
		...
		addSprite(31001, 638);
		addSprite(31002, 636);
		addHoverButton(31003, 642, 44, 20, "View @or1@Server @whi@Information", -1, 31004, 1);
		addHoveredButton(31004, 641, 44, 20, 31005);
		addHoverButton(31006, 642, 44, 20, "View @or1@Slayer @whi@Information", -1, 31007, 1);
		addHoveredButton(31007, 641, 44, 20, 31008);
		addHoverButton(31009, 642, 44, 20, "View @or1@Quests", -1, 31010, 1);
		addHoveredButton(31010, 641, 44, 20, 31011);
		addSprite(31012, 646);
		addSprite(31013, 645);
		addSprite(31014, 644);
		addSprite(31015, 643);
		...
		addSprite(31017, 640);
		addSprite(31018, 637);
		addButton(31019, 31000, 91, 54, 637, 637, 31020, "View @or1@Achievements");
		addButton(31021, 31000, 91, 54, 637, 637, 31022, "View @or1@Collection Log");
		addButton(31023, 31000, 184, 26, 639, 639, 31024, "View @or1@Player Panel");
		addText(31025, "Combat Level:", fonts, 0, 0xff991f, true, true);
		addText(31026, "Total Level:", fonts, 0, 0xff991f, true, true);
		addText(31027, "Total Xp:", fonts, 0, 0xff991f, false, true);
		addText(31028, "Quests", fonts, 0, 0xff991f, true, true);
		addText(31029, "Completed:", fonts, 0, 0xff991f, true, true);
		addText(31030, "Slayer Tasks", fonts, 0, 0xff991f, true, true);
		addText(31031, "Completed:", fonts, 0, 0xff991f, true, true);
		addText(31032, "Achievements", fonts, 0, 0xff991f, true, true);
		addText(31033, "Completed:", fonts, 0, 0xff991f, true, true);
		addText(31034, "Collections", fonts, 0, 0xff991f, true, true);
		addText(31035, "Logged:", fonts, 0, 0xff991f, true, true);
		addText(31036, "Player Panel", fonts, 0, 0xff991f, true, true);
		addSprite(31037, 647);
		addSprite(31038, 648);
		addSprite(31039, 649);
		addSprite(31040, 650);
		addSprite(31041, 651);
		addText(31042, "126", fonts, 0, 0x0dc10d, false, true);
		addText(31043, "2277", fonts, 0, 0x0dc10d, false, true);
		addText(31044, "0", fonts, 0, 0x0dc10d, false, true);
		addText(31045, "0/0", fonts, 0, 0x0dc10d, false, true);
		addText(31046, "0", fonts, 0, 0x0dc10d, false, true);
		addText(31047, "0/0", fonts, 0, 0x0dc10d, false, true);
		addText(31048, "0/0", fonts, 0, 0x0dc10d, false, true);
		
		
		tab.child(0, 31001, 0, 0);
		tab.child(1, 31002, 5, 3);
		tab.child(2, 31003, 51, 3);
		tab.child(3, 31004, 51, 3);
		tab.child(4, 31006, 97, 3);
		tab.child(5, 31007, 97, 3);
		tab.child(6, 31009, 143, 3);
		tab.child(7, 31010, 143, 3);
		tab.child(8, 31012, 19, 5);
		tab.child(9, 31013, 65, 5);
		tab.child(10, 31040, 111, 5);
		tab.child(11, 31015, 157, 5);
		tab.child(12, 31016, 3, 44);
		tab.child(13, 31016, 96, 44);
		tab.child(14, 31017, 3, 88);
		tab.child(15, 31018, 3, 118);
		tab.child(16, 31018, 96, 118);
		tab.child(17, 31019, 3, 174);
		tab.child(18, 31021, 96, 174);
		tab.child(19, 31023, 3, 230);
		tab.child(20, 31025, 48, 51);
		tab.child(21, 31026, 141, 51);
		tab.child(22, 31027, 50, 97);
		tab.child(23, 31028, 48, 124);
		tab.child(24, 31029, 48, 134);
		tab.child(25, 31030, 141, 124);
		tab.child(26, 31031, 141, 134);
		tab.child(27, 31032, 48, 180);
		tab.child(28, 31033, 48, 190);
		tab.child(29, 31034, 141, 180);
		tab.child(30, 31035, 141, 190);
		tab.child(31, 31036, 95, 237);
		tab.child(32, 31037, 30, 65);
		tab.child(33, 31038, 117, 65);
		tab.child(34, 31039, 29, 93);
		tab.child(35, 31013, 15, 149);
		tab.child(36, 31040, 111, 149);
		tab.child(37, 31014, 17, 206);
		tab.child(38, 31041, 107, 206);
		tab.child(39, 31042, 51, 67);
		tab.child(40, 31043, 140, 67);
		tab.child(41, 31044, 98, 97);
		tab.child(42, 31045, 38, 153);
		tab.child(43, 31046, 134, 153);
		tab.child(44, 31047, 40, 209);
		tab.child(45, 31048, 130, 209);
	}
