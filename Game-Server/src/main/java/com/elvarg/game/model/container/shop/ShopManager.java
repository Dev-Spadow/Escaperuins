...
public class ShopManager extends ShopIdentifiers {
    ...
    public static void open(Player player, Shop shop, boolean scrollReset) {
        ...
        player.getPacketSender().sendString(Shop.CURRENT_POINTS_ID, "");
    ...
    private static int getItemValue(Player player, ItemDefinition itemDef, int shopId) {
        ...
        switch (itemDef.getId()) {
            ...
            case ItemIdentifiers.OLD_SCHOOL_BOND:
                if (shopId == SLAYER_POINTS_SHOP) {
                    return 250;
                }
                if (shopId == SKILLING_POINTS_SHOP) {
                    return 100000;
                }
                break;
        }
    ...
    private static String getCurrencyName(Player player, ItemDefinition itemDef, int shopId) {
        ...
        switch (shopId) {
            ...
            case POINTS_SHOP:
                return "points";
            case SLAYER_POINTS_SHOP:
                return "slayer points";
            case SKILLING_POINTS_SHOP:
    ...
    private static int getCurrencyAmount(Player player, ItemDefinition itemDef, int shopId) {
        switch (shopId) {
            ...
            case SKILLING_POINTS_SHOP:
                return player.getSkillingPoints();
            case PVP_SHOP:
    ...
    private static void decrementCurrency(Player player, ItemDefinition itemDef, int amount, int shopId) {
        switch (shopId) {
            ...
            case SLAYER_POINTS_SHOP:
                ...
                break;
            case SKILLING_POINTS_SHOP:
                player.setSkillingPoints(player.getSkillingPoints() - amount);
                break;
            case PVP_SHOP:
