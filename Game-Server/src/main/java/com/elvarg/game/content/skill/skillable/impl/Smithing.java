...
public class Smithing extends ItemIdentifiers {
    ...
    public static int getExperienceForBar(int barId) {
    	switch (barId) {
    		case 2349:
    			return 9;
    		case 2351:
     ...
     */
    public enum Bar {
        BRONZE_BAR(2349, new RequiredItem[]{new RequiredItem(new Item(438), true), new RequiredItem(new Item(436), true)}, 1, 9, 2405, new int[][]{{3987, 1}, {3986, 5}, {2807, 10}, {2414, -1}}, Optional.of(SmithableEquipment.BRONZE_ITEMS)),
        IRON_BAR(2351, new RequiredItem[]{new RequiredItem(new Item(440), true)}, 15, 20, 2406, new int[][]{{3991, 1}, {3990, 5}, {3989, 10}, {3988, -1}}, Optional.of(SmithableEquipment.IRON_ITEMS)),
        SILVER_BAR(2355, new RequiredItem[]{new RequiredItem(new Item(442), true)}, 20, 40, 2407, new int[][]{{3995, 1}, {3994, 5}, {3993, 10}, {3992, -1}}, Optional.empty()),
        STEEL_BAR(2353, new RequiredItem[]{new RequiredItem(new Item(440), true), new RequiredItem(new Item(453, 2), true)}, 30, 70, 2409, new int[][]{{3999, 1}, {3998, 5}, {3997, 10}, {3996, -1}}, Optional.of(SmithableEquipment.STEEL_ITEMS)),
        GOLD_BAR(2357, new RequiredItem[]{new RequiredItem(new Item(444), true)}, 40, 65, 2410, new int[][]{{4003, 1}, {4002, 5}, {4001, 10}, {4000, -1}}, Optional.empty()),
        MITHRIL_BAR(2359, new RequiredItem[]{new RequiredItem(new Item(447), true), new RequiredItem(new Item(453, 4), true)}, 50, 140, 2411, new int[][]{{7441, 1}, {7440, 5}, {6397, 10}, {4158, -1}}, Optional.of(SmithableEquipment.MITHRIL_ITEMS)),
        ADAMANTITE_BAR(2361, new RequiredItem[]{new RequiredItem(new Item(449), true), new RequiredItem(new Item(453, 6), true)}, 70, 200, 2412, new int[][]{{7446, 1}, {7444, 5}, {7443, 10}, {7442, -1}}, Optional.of(SmithableEquipment.ADAMANT_ITEMS)),
        RUNITE_BAR(2363, new RequiredItem[]{new RequiredItem(new Item(451), true), new RequiredItem(new Item(453, 8), true)}, 85, 265, 2413, new int[][]{{7450, 1}, {7449, 5}, {7448, 10}, {7447, -1}}, Optional.of(SmithableEquipment.RUNE_ITEMS)),;
