...
public class PlayerLoading {
    ...
    public static int getResult(Player player) {
        ...
        try (FileReader fileReader = new FileReader(file)) {
            ...
            if (reader.has("membership")) {
                player.getMembership().setAs(builder.fromJson(reader.get("membership"), Membership.class));
            }
            ...
            if (reader.has("skilling-points")) {
                player.setSkillingPoints(reader.get("skilling-points").getAsInt());
            }
