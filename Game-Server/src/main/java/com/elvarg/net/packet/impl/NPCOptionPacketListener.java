...
import com.elvarg.game.content.skill.skillable.impl.Fishing.FishingSpot;
	...
	private static void firstClick(Player player, Packet packet) {
        ...
        player.setWalkToTask(new WalkToAction(player) {
			...
			public void execute() {
				...
				if (npc.getDefinition().getName().toLowerCase().contains("bank")) {
				...
				case SHOP_KEEPER_4:
					...
					break;
				case TURAEL:
					Slayer.assign(player);
				break;
				case 1497: // Net and bait
				case 1498: // Net and bait
					player.getSkillManager().startSkillable(new Fishing(npc, FishingSpot.SMALL_NET_OCEAN));
					break;
				}
            }
	...
	public void handleSecondClick(Player player, Packet packet) {
        ...
        player.setWalkToTask(new WalkToAction(player) {
			...
			public void execute() {
				...
				case 1497: // Net and bait
				case 1498: // Net and bait
					player.getSkillManager().startSkillable(new Fishing(npc, FishingSpot.FISHING_ROD_OCEAN));
					break;
				case RICHARD_2:
	...
	public void handleThirdClick(Player player, Packet packet) {
        ...
        player.setWalkToTask(new WalkToAction(player) {
            ...
            public void execute() {
                ...
                switch (npc.getId()) {
				case TURAEL:
					ShopManager.open(player, ShopIdentifiers.SLAYER_POINTS_SHOP);
				break;
                case EMBLEM_TRADER:
                    // Sell emblems option
